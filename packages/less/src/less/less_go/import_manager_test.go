...
func (m *MockEnvironment) GetFileManager(path, currentDirectory string, context map[string]any, environment ImportManagerEnvironment) FileManager {
	return m.FileManager
}

// MockImportFileManager implements the FileManager interface
type MockImportFileManager struct {
	LoadFileSyncFunc         func(path, currentDirectory string, context map[string]any, environment ImportManagerEnvironment) *LoadedFile
	LoadFileFunc             func(path, currentDirectory string, context map[string]any, environment ImportManagerEnvironment, callback func(error, *LoadedFile)) any
...
func (m *MockImportFileManager) LoadFileSync(path, currentDirectory string, context map[string]any, environment ImportManagerEnvironment) *LoadedFile {
...
func (m *MockImportFileManager) LoadFile(path, currentDirectory string, context map[string]any, environment ImportManagerEnvironment, callback func(error, *LoadedFile)) any {
...
func (m *MockImportFileManager) GetPath(filename string) string {
...
func (m *MockImportFileManager) Join(path1, path2 string) string {
	if m.JoinFunc != nil {
...
func (m *MockImportFileManager) PathDiff(currentDirectory, entryPath string) string {
...
func (m *MockImportFileManager) IsPathAbsolute(path string) bool {
...
func (m *MockImportFileManager) AlwaysMakePathsAbsolute() bool {
...
func createMockEnvironment() *MockEnvironment {
	return &MockEnvironment{
		FileManager: &MockImportFileManager{},
	}
}
