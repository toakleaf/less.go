...
import Node from '@less/tree/node';
import Declaration from '@less/tree/declaration';
import Anonymous from '@less/tree/anonymous';
import contexts from '@less/contexts';
import globalFunctionRegistry from '@less/functions/function-registry';
import defaultFunc from '@less/functions/default';
import getDebugInfo from '@less/tree/debug-info';
import Parser from '@less/parser/parser';
