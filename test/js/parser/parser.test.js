...
import Parser from '@less/parser/parser'; // Assuming parser.js is in the same directory
// import getParserInput from '@less/parser/parser-input'; // Removed as unused
